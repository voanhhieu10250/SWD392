            ...
            <div className="grid grid-cols-12 p-4">
              ...
              <div className="col-span-11">
                <form action="" method="post">
                  <textarea name="comment" placeholder="Write a comment" className="w-full h-[200px] resize-none bg-gray-500 text-white p-2"></textarea>
                  <div className="flex justify-end">
                    <button type="submit" className="p-2 bg-blue-500 rounded-md text-white hover:bg-blue-700 transition-all duration-300 ease-in-out">Submit</button>
                  </div>
                </form>
              </div>
            </div>
