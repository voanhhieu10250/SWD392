...
import ActivityLog from './modal/ActivitiLog'
        ...
        <div className='ml-2'>
          ...
          <div className='mt-2'>
            <div className='flex justify-between'>
              <div className='flex justify-between'>
                <button
                  className='hover:text-green-500 flex items-center mr-1 transition-all duration-200'
              ...
              <div className='inline-flex '>
                ...
                <div className='ml-2'>
                  ...
                  <div className=''>
                    ...
                    <a href='' className='ml-1 hover:text-green-500 font-bold'>
                      LetMeKnow
                    </a>
                  </div>
                </div>
          ...
          <div className='mt-2'>
            <div className='flex justify-center'>
              <div className='bg-gray-400 p-3'>
                  ...
                  <div className='inline-flex'>
                    ...
                    <div className='ml-2 mr-4'>
                      ...
                      <div className=''>
                        <a
                          href=''
                          className='ml-1 text-white hover:text-green-300 font-bold transition-all duration-200'
                        >
                          LetMeKnow
                        </a>
                      </div>
                ...
                <div className='flex justify-center'>
                  <button
                    className='mt-2 text-white hover:text-green-300 transition-all duration-200 flex items-center'
                    onClick={handleButtonClickActivityLog}
                  >
                    <span className='mr-1'>
                      <RiRepeatFill />
                    </span>
          ...
          <div className='mt-2'>
            <div className='max-w-3xl'>
              <Description
                text={
                  'Tả con trâu nằm trong bài văn Tả con vật, có trong chương trình của cả 3 bộ sách Kết nối tri thức, Chân trời sáng tạo, Cánh diều. Vậy mời các em cùng theo dõi bài viết dưới đây của Download.vn để có thêm nhiều vốn từ, nhanh chóng hoàn thiện bài văn của mình thật hay.'
                }
                maxLength={50}
              />
            </div>
          ...
          <div className='mt-2'>
            {imageInfo && (
              <div className='text-gray-500'>
                <p>
                  Image size: {imageInfo.width}x{imageInfo.height}px {imageInfo.sizeInMB.toFixed(2)} MB
                </p>
              </div>
            )}
          </div>
              ...
              <div className='col-span-11'>
                <form action='' method='post'>
                  <textarea
                    ...
                    className='w-full h-[200px] resize-none bg-gray-500 text-white p-2'
                  ></textarea>
                  <div className='flex justify-end'>
                    <button
                      type='submit'
                      className='p-2 bg-blue-500 rounded-md text-white hover:bg-blue-700 transition-all duration-300 ease-in-out'
                    >
                      Submit
                    </button>
                  </div>
