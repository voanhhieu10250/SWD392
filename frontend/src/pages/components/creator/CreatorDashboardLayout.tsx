            ...
            <ul className='space-y-2 font-medium'>
              ...
              <li>
                ...
                >
                  ...
                  <span className='flex-1 ms-3 whitespace-nowrap'>Your Pre-Orders</span>
                </NavLink>
              </li>
              <li>
                <NavLink
              ...
              <li>
                <button
                  type='button'
                  className='w-full flex items-center text-start p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group'
                  onClick={() => {
                    logout()
